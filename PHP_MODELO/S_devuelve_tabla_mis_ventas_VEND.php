	...
	while(isset($inf_mis_ventas['ID_VENTA'][$i])){
		if($inf_mis_ventas['ID_VENTA'][$i]<>""){
			...
			echo "
				...
				<td class='text-center'><a href='ZV_ver_recibo.php?id_venta=" . $inf_mis_ventas['ID_VENTA'][$i] . "' target='_blank' title='ver recibo'><span class='text-primary fa fa-eye'></span> Ver Recibo</a><br><a href='ZV_ver_recibo.php?id_venta=" . $inf_mis_ventas['ID_VENTA'][$i] . "&ver=no' title='ver recibo'><span class='text-primary fa fa-download'></span> Descargar Recibo</a><br><a href='ZV_ver_abonos.php?id_venta=" . $inf_mis_ventas['ID_VENTA'][$i] . "' title='ver abonos'><span class='text-primary fa fa-eye'> Ver Abonos</span></a>
			";
