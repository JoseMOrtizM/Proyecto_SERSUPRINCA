...
<body>
	...
	<section class="container-fluid my-5">
		<div class="row bg-naranja my-0 px-2 py-1 border border-dark">
				...
				<div class="col-md-12">
					<div class='input-group mb-2'>
						...
						<select class='form-control col-md-10 p-0 m-0 px-2 rounded-0 para_ajax' name='cedula_rif_cliente' id='cedula_rif_cliente' required autocomplete='off'>
							<option>TODOS</option>
							<?php
								$inf_clientes= M_ventas_R_mis_clientes($conexion, $datos_usuario_session['CEDULA_RIF'][0]);
								$i=0;
			...
			<script type="text/javascript">
				$(document).ready(function(){
					...
					$.ajax("PHP_MODELO/S_devuelve_tabla_mis_ventas_VEND.php",{data:{ced_cliente:ced_cliente,ced_vendedor:ced_vendedor,tipo:tipo,estatus:estatus,entrega:entrega}, type:'post',async:false}).done(function(respuesta){
